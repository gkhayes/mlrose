...
def genetic_alg(problem, pop_size=200, pop_breed_percent=0.75, elite_dreg_ratio=0.95,
    ...
    return genetic_alg_orig(problem, pop_size, pop_breed_percent, elite_dreg_ratio,
                            minimum_elites, minimum_dregs, mutation_prob,
                            max_attempts, max_iters, curve, random_state,
                            state_fitness_callback, callback_user_info,
                            hamming_factor, hamming_decay_factor)


def genetic_alg_orig(problem, pop_size=200, pop_breed_percent=0.75, elite_dreg_ratio=0.95,
                minimum_elites=0, minimum_dregs=0, mutation_prob=0.1,
                max_attempts=10, max_iters=np.inf, curve=False, random_state=None,
                state_fitness_callback=None, callback_user_info=None,
                hamming_factor=0.0, hamming_decay_factor=0):
...
def genetic_alg_new(problem, pop_size=200, pop_breed_percent=0.90, elite_dreg_ratio=0.95,
                minimum_elites=0, minimum_dregs=0, mutation_prob=0.1,
                max_attempts=10, max_iters=np.inf, curve=False, random_state=None,
                state_fitness_callback=None, callback_user_info=None,
                hamming_factor=0.0, hamming_decay_factor=0):
