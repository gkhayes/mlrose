...
pylint discrete.py --score=no --disable=R0201,R0902,R0903,R0904,R0913,R0914,C0103,C1801
...
pylint test.py --score=no --disable=R0201,R0902,R0903,R0904,R0913,R0914,C0103,C1801
pycodestyle test.py
flake8 test.py
